...
EFI_HII_CONFIG_ACCESS_PROTOCOL gMyTestDriverHiiConfigAccess = {
  MyTestDriverHiiConfigAccessExtractConfig,
  MyTestDriverHiiConfigAccessRouteConfig,
  MyTestDriverHiiConfigAccessCallback
};
