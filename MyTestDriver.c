...
EFI_DRIVER_SUPPORTED_EFI_VERSION_PROTOCOL gMyTestDriverDriverSupportedEfiVersion = {
...
///
EFI_DRIVER_BINDING_PROTOCOL gMyTestDriverDriverBinding = {
  MyTestDriverDriverBindingSupported,
  MyTestDriverDriverBindingStart,
  MyTestDriverDriverBindingStop,
  MY_TEST_DRIVER_VERSION,
  NULL,
  NULL
};
  ...
  )
{
  ...
  Status = gBS->UninstallMultipleProtocolInterfaces (
                  ImageHandle,
                  &gEfiDriverBindingProtocolGuid,  &gMyTestDriverDriverBinding,
                  &gEfiComponentNameProtocolGuid,  &gMyTestDriverComponentName,
                  &gEfiComponentName2ProtocolGuid, &gMyTestDriverComponentName2,
                  NULL
                  );
  if (EFI_ERROR (Status)) {
    return Status;
  ...
  Status = gBS->UninstallMultipleProtocolInterfaces (
                  ImageHandle,
                  &gEfiDriverSupportedEfiVersionProtocolGuid, &gMyTestDriverDriverSupportedEfiVersion,
                  NULL
                  );
  if (EFI_ERROR (Status)) {
    return Status;
  ...
  )
{
  ...
  PrivateData->Signature = MYTESTDRIVER_DEV_SIGNATURE;
